...
#define ANALOGSETTINGSADDR       (DSO_SFR_BASE_ADDR+ 4*25)
#define LASTADDR                 (DSO_SFR_BASE_ADDR+ 4*26)

#define LEDADDR					 (FRONTPANEL_BASE_ADDR + 4*0)
#define KEYADDR					 (FRONTPANEL_BASE_ADDR + 4*1)
#define ENCADDR_MISC			 (FRONTPANEL_BASE_ADDR + 4*2)
#define ENCADDR_VOLTAGE			 (FRONTPANEL_BASE_ADDR + 4*3)
#define ENCADDR_UPDOWN			 (FRONTPANEL_BASE_ADDR + 4*4)

#define DSO_REG_SIZE             (4*26)
